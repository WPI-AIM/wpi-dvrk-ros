...
void DVRK_Arm::init(){
    originFrame.trans.setOrigin(tf::Vector3(0,0,0));
    tf::Quaternion temp_quat;
    temp_quat.setRPY(0,0,0);
    originFrame.trans.setOrigin(tf::Vector3(0,0,0));
    originFrame.trans.setRotation(temp_quat);
    afxdTipFrame.trans.setOrigin(tf::Vector3(0,0,0));
    afxdTipFrame.trans.setRotation(temp_quat);
    eeCmd.trans.setOrigin(tf::Vector3(0,0,0));
    eeCmd.trans.setRotation(temp_quat);
}
